    ...
    >
      ...
      {props._showDropRegion && props._dropRegionTime && activeSlot && (
        <div
          ...
          style={{
            left: `${((timeToMinutes(props._dropRegionTime) - config.startHour * 60) * pixelsPerMinute) + (config.columnWidth || 112)}px`,
            width: `${activeSlot.duration * pixelsPerMinute}px`,
          }}
        >
